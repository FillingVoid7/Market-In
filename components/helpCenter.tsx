    ...
    <section className="py-16 px-6 bg-gray-50 mt-8 text-black">
      <div className="container mx-auto max-w-3xl">
        ...
        <p className="text-gray-700 mb-8 text-center">
          Welcome to our Help Center. If you need assistance, check out our
          resources below or contact us for further support.
        </p>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md mb-8">
          ...
          <p className="text-gray-600 mb-2">
            Email:{" "}
            <a href="mailto:support@example.com" className="text-orange-600">
              support@example.com
            </a>
          </p>
          <p className="text-gray-600">
            Phone: <span className="text-orange-600">+977-1-1234567</span>
          </p>
        </div>
