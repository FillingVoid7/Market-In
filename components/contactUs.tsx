  ...
  const articles = [
    {
      ...
      description: "Tips and tricks to get the most out of our features and tools.",
      date: "October 20, 2024",
    },
    {
      title: "Top 10 Features for Small Businesses",
      description: "Explore the best features that can help your business grow.",
  ...
  return (
    <section className="py-16 px-6 bg-gray-50 mt-8">
      <div className="container mx-auto max-w-3xl">
        <h2 className="text-4xl font-bold text-gray-800 mb-6 text-center">Blog</h2>
